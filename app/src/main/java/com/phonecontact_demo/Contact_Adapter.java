...
public class Contact_Adapter extends BaseAdapter {
    ...
    public void setCommonlist(ArrayList<Contact_Model> commonlist, boolean isProcessCompleted) {
        if (commonlist == null)
            return;
        arrayList.clear();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (model != null) {
            ...
            if (model.getContactEmail() != null && !model.getContactEmail().equals("")
            ...
            if (model.getContactNumber() != null && !model.getContactNumber().equals("")
            ...
            if (model.getContactOtherDetails() != null && !model.getContactOtherDetails().equals("")
            ...
            Bitmap image = null;
            if (model.getContactPhoto() != null && !model.getContactPhoto().equals("")
